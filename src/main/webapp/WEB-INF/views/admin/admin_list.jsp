        ...
        <div id="main">
            <form action="" method="">
                ...
                <div class="search_add">
                    ...
                    <input type="button" value="增加" class="btn_add" onclick="location.href='admin/admin_add.jsp';" />
                </div>
                <!--删除和密码重置的操作提示-->
               ...
               <c:forEach var="c" items="${listAdmin}" varStatus="st">
                        <tr>
                            ...
                            <td class="td_modi">
                                <input type="button" value="修改" class="btn_modify" onclick="location.href='admin/admin_modi.jsp';" />
