...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="post" method="admin_modi.do" class="main_form">
                    <div class="text_info clearfix"><span>姓名：</span></div>
                    <div class="input_info">
                        <input type="text" value="${sessionScope.user.uname}" name="uname"/>
                        <span class="required">*</span>
                        <div class="validate_msg_long error_msg" style="display: none;">20长度以内的汉字、字母、数字的组合</div>
                    </div>
                    <div class="text_info clearfix"><span>管理员账号：</span></div>
                    <div class="input_info"><input type="text" readonly="readonly" class="readonly" value="admin1"  /></div>
                    <div class="text_info clearfix"><span>电话：</span></div>
                    <div class="input_info">
                        <input type="text" value="${sessionScope.user.utel}" name="utel" />
                        <span class="required">*</span>
                        <div class="validate_msg_long error_msg" style="display: none;">正确的电话号码格式：手机或固话</div>
                    </div>
                    <div class="text_info clearfix"><span>Email：</span></div>
                    <div class="input_info">
                        <input type="text" class="width200" value="${sessionScope.user.uemail}" name="uemail"/>
                        <span class="required">*</span>
